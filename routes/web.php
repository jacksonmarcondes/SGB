...
Route::prefix('reservas')->group(function () {
    Route::get('listar',[Reserva::class,'listarReservas']);
...
Route::prefix('titulos')->group(function () {
    ...
    Route::post('inativar',[Titulo::class,'inativarTitulo'])->name('titulo.inativar');
...
Route::prefix('usuarios')->group(function () {
    ...
    Route::post('inativar',[Usuario::class,'inativarUsuario'])->name('usuario.inativar');
